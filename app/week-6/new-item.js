    ...
    return (
        <div className="flex justify-left mt-4 ml-6 mb-4">
            <form onSubmit={handleSubmit} className="w-full max-w-xs">
                ...
                <button type="submit" className="bg-hot bg-hot bg-pink-500 hover:bg-pink-700 text-white w-full font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline ">+</button>
            </form>
        </div>
    );
};
